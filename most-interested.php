...
<head>
    ...
    <title>Most Interested Products - Az Furniture</title>
...
<body>
    <div class="header">
        <div class="d-flex justify-content-between align-items-center w-100 px-3">
            ...
            <h1 class="mb-0 ms-3">Most Interested Products</h1>
        </div>
    </div>
    ...
    <div class="product-grid">
        <?php
        $featured_query = "SELECT * FROM products WHERE is_featured = 1 AND is_active = 1 ORDER BY created_at DESC";
