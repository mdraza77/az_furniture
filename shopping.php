...
<head>
    ...
    <title>Shopping - Az Furniture</title>
...
<body>
    <div class="header">
        <div class="d-flex justify-content-between align-items-center w-100 px-3">
            ...
            <h1 class="mb-0 ms-3">Shopping</h1>
        </div>
    </div>
    ...
    <div class="filter-section">
        ...
        while ($category = $categories_result->fetch_assoc()) {
            echo '<button class="filter-btn" data-filter="' . strtolower($category['slug']) . '">' . htmlspecialchars($category['name']) . '</button>';
        }
        ?>
    ...
    <div class="product-grid">
        <?php
        $products_query = "SELECT p.*, c.slug as category_slug FROM products p 
        ...
        while ($product = $products_result->fetch_assoc()) {
            ...
            $category = strtolower($product['category_slug'] ?? 'other');
            $is_sale = $product['sale_price'] ? 'sale' : '';
        ?>
            <div class="product-card" data-category="<?php echo $category; ?>" data-sale="<?php echo $is_sale; ?>">
        ...
        filterButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                productCards.forEach(card => {
                    ...
                    const isSale = card.getAttribute('data-sale');

                    if (filter === 'all') {
                        card.style.display = 'flex';
                    } else if (filter === 'sale') {
                        card.style.display = isSale === 'sale' ? 'flex' : 'none';
                    } else {
